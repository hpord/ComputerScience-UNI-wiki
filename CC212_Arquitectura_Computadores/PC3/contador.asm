;contador decimal lcd que envia al terminal y al lcd
org 8000h
lcall inicioLCD
mov A, #1
mov B, #0
...
loop:
 mov A, R6
 lcall binasc
 mov 30h, R2 ; EL PRIMER DIGITO LO MUEVE A R2 
 mov A, R2
 lcall sndchr
 mov A, #0dh
 lcall sndchr
...
; ==========================================================
; subrutina placeCur4
; Esta subrutina fija la posición del cursor. La posición del cursor
...
;registros afectados: A y R3. Se guarda en A el número de posiciones.
;=======================================================================	
positionNTerminal:
		mov R3,A
sigue:
