;Hacer un programa que muestre Hola mundo!..... en la primera fila del display LCD y muestre Como les va ?. en la segunda fila. Todo este texto de ambas filas que lo envíe también al terminal. Sugerencia: Usar la subrutina “print” para el terminal.	
