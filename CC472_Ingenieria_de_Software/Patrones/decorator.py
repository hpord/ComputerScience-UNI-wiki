# este patrón permite ir añadiendo carácterísticas en la marcha
...
if __name__ == '__main__':
    ...
    print('Ingredientes: '+ myCoffee.get_ingredients()+
    '\tCoste: '+str(myCoffee.get_cost()) + '\tImpuesto de venta = '+str(myCoffee.get_tax()))
