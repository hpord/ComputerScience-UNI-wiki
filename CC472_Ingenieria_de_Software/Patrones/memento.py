# este patrón permite regresar a un estrado anterior
...
class Caretaker():
    ...
    def backup(self) -> None:
        print("\nGuardian: Salvar el estado del originador...")
    ...
    def undo(self) -> None:
        ...
        print(f"Guardian: Restaurando el estado a: {memento.get_name()}")
        try:
    ...
    def show_history(self) -> None:
        print("Guardian: Aquí está la lista de mementos:")
