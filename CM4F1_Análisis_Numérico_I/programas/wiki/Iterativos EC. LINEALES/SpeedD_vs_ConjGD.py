import numpy as np
import holoviews as hv   # instale este paquete con PIP
hv.extension('plotly')
...
if __name__ == '__main__':
    ...
    A = np.array([[10.0, 3.0, 1.0], [3.0, 10.0, 3.0], [1.0, 3.0, 10.0]])
    b = np.array([14.0, -5.0, 14.0])

    initial = np.array([0.0, 0.0, 0.0])
    # visualize steepest descent method
    _, x_steps, y_steps = steepest_descent_store_result(A, b, x0=initial)
